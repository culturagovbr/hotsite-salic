...
<header>
    ...
    <section class="complete-content">	
     ...
     <div class="bread-crumb-wrap" style="background:url(images/bc-back1.jpg) no-repeat 0px 0px;">
        <div class="container">
    <!--Title / Beadcrumb-->
            <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
                <div class="bread-heading"><h1>Download do App Salic Mobile</h1></div>
<!--                <div class="bread-crumb pull-right">
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li><a href="#">Salic Mobile</a></li>
                    </ul>
                </div>-->
            </div>
         </div>
         ...
         <div class="container">
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                  ...
                  <div class="search-result">
                    <h2 class="subtitle">Faça seu download agora mesmo!</h2>
                    <p style="text-align: center"><img src="images/Cartaz.png"></p>
                  </div>  
