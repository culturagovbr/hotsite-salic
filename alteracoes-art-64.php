              ...
              <div class="tabbable tabs-left">
                ...
                <div class="tab-content col-md-12 col-sm-12 col-xs-7 pull-right">
                 ...
                 <div class="tab-pane active" id="a">
                    <div class="dept-title-tabs">Alterações Art. 64</div>
                    <p>
                        Art. 64. O projeto cultural somente poderá ser alterado após a publicação da autorização para captação de recursos, mediante solicitação do proponente ao MinC, devidamente justificada e formalizada, no mínimo, trinta dias antes do início da execução da meta ou ação a ser alterada.<br><br>
                        § 1° Alterações de nome, local de realização e plano de distribuição somente serão objeto de análise após a captação de vinte por cento do valor aprovado do projeto, ressalvados os projetos contemplados em seleções públicas ou respaldados por contrato de patrocínio.<br>
                        § 2º Para alteração do nome do projeto deverá ser apresentada anuência dos patrocinadores, e se for o caso, anuência do autor da obra.<br>
                        § 3° No caso de alteração do local de realização do projeto, o proponente deverá apresentar:<br><br>
                        I – anuência dos patrocinadores;<br>
                        II – anuência do responsável pelo novo local de realização;<br>
                        III – planilha orçamentária adequada à nova realidade, mesmo que não haja alteração do valor aprovado; e<br>
