    	...
    	<div class="container">
            <!--Title / Beadcrumb-->
         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            	<div class="bread-heading"><h1>Dicas do Salic</h1></div>
              ...
              <div class="tabbable tabs-left">
                ...
                <div class="tab-content col-md-12 col-sm-12 col-xs-7 pull-right">
                 ...
                 <div class="tab-pane active" id="a">
                    <div class="dept-title-tabs">Todos os seus objetivos descritos serão avaliados na prestação de contas. Especifique para ser claro!</div>
                    <p>
                        Os objetivos devem ser formulados com intuito de especificar aquilo que se quer atingir a partir da realização do projeto, de seus produtos finais, bem como os benefícios da ação cultural, se possível, a curto, médio e a longo prazo.
                        <br><br>
                        Objetivo Geral: descreve de forma clara e precisa a ideia central da proposta e seu produto final: PARA QUÊ realizar o projeto?
                        <br><br>
                        Objetivo Específico: Elenca as diversas ações que concorrem para a efetivação do objetivo geral. É descrito de forma mais detalhada do que o objetivo geral: Quais os produtos e os resultados do projeto?
                        <br><br>
                        Dica: NÃO insira em ‘Objetivos’ informações referentes a: acessibilidade, democratização de acesso, preço de ingresso, estimativa de público, ficha técnica e datas do período de realização do projeto.
                        <br><br>
                        ATENÇÃO: Registra-se que todos os objetivos (gerais e específicos) apresentados na inscrição da proposta cultural devem ser comprovados ao final da execução do projeto, na fase de prestação de contas.
