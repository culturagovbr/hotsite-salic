              ...
              <div class="tabbable tabs-left">
                ...
                <div class="tab-content col-md-12 col-sm-12 col-xs-7 pull-right">
                 ...
                 <div class="tab-pane active" id="a">
                    <div class="dept-title-tabs">Ao escrever o resumo da sua proposta cultural responda à pergunta: “O quê?”</div>
                    <p>
                        O resumo do seu projeto cultural deve descrever o que se pretende realizar em no máximo 5 linhas, limitado ao máximo de 1000 caracteres. Trata-se de uma síntese com as informações essenciais fazendo referência aos produtos cadastrados no Plano de Distribuição (item 15). Ao redigir seu resumo responda à questão “O quê?”.
                        <br>
                        Exemplo de resumos:
                        <br>
                        Realização do Festival de Cultura de Brasília com seis apresentações de música popular e três apresentações de teatro.
                        <br><br>
                        <strong> NÃO insira no seu resumo informações referentes a: estimativa de público, valores de ingressos, justificativas e datas do período de realização do projeto.</strong>
                        <br><br> <br><br>
                    </p>
