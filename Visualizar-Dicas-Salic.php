    	...
    	<div class="container">
            <!--Title / Beadcrumb-->
         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            	<div class="bread-heading"><h1>Lista de Dicas do Salic</h1></div>
              ...
              <div class="tabbable tabs-left">
                ...
                <div class="tab-content col-md-12 col-sm-12 col-xs-7 pull-right">
                 ...
                 <div class="tab-pane active" id="a">
                    ...
                    <p>
                        <a href="Dicas-do-Salic-1.php"><h4>1.	Atente-se ao nome de sua Proposta Cultural!</h4></a><br>
                        <a href="Dicas-do-Salic-2.php"><h4>2.	Ao escrever o resumo da sua proposta cultural responda à pergunta: “O quê?”</h4></a><br>
                        <a href="Dicas-do-Salic-3.php"><h4>3.	Todos os seus objetivos descritos serão avaliados na prestação de contas. Especifique para ser claro!</h4></a><br>
                        <a href="Dicas-do-Salic-4.php"><h4>4.	Desenvolva a prestação de contas ao longo da execução do projeto!</h4></a><br>
                        <a href="Dicas-do-Salic-5.php"><h4>5.	Até 20% do valor aprovado, você mesmo faz seu remanejamento.</h4></a><br>
                        <a href="Dicas-do-Salic-6.php"><h4>6.	Sobrou saldo?</h4></a><br>
                        <a href="Dicas-do-Salic-7.php"><h4>7.	Atente-se para a data de emissão dos documentos fiscais.</h4></a><br>
                        <a href="Dicas-do-Salic-8.php"><h4>8.	Praticamente todas as extensões de arquivos de imagens podem ser inseridas no Salic.</h4></a><br>
                        <a href="Dicas-do-Salic-9.php"><h4>9.	Entidade sem fim lucrativo também pode emitir nota fiscal!</h4></a><br>
                        <a href="Dicas-do-Salic-10.php"><h4>10.	Alerte os passageiros.</h4></a><br>
                        <a href="Dicas-do-Salic-11.php"><h4>11.	Atente-se para o caráter desconcentrador do Pronac</h4></a><br>
