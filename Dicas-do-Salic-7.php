              ...
              <div class="tabbable tabs-left">
                ...
                <div class="tab-content col-md-12 col-sm-12 col-xs-7 pull-right">
                 ...
                 <div class="tab-pane active" id="a">
                    <div class="dept-title-tabs">Atente-se para a data de emissão dos documentos fiscais</div>
                    <p>
                        Os documentos fiscais devem constar a data de emissão a partir da data da publicação da portaria de aprovação e autorização para a captação de recursos (§1º do art. 35 do decreto 5761/2006 e caput do art. 49 da IN MinC 01/2013) e não ter data de emissão posterior ao término do prazo de execução do projeto.
