              ...
              <div class="tabbable tabs-left">
                ...
                <div class="tab-content col-md-12 col-sm-12 col-xs-7 pull-right">
                 ...
                 <div class="tab-pane active" id="a">
                    <div class="dept-title-tabs">Alerte os passageiros</div>
                    <p>
                        Para a prestação de contas são necessárias também as cópias dos cartões de embarque. Assim, solicite que os passageiros guardem e enviem para você, proponente, os cartões para serem anexados no Salic como item integrante da prestação de contas. Além dos cartões é necessário enviar, para casos de compra pela internet, o comprovante da compra online que contemple o detalhamento das informações: nome completo dos passageiros, trechos, datas, valor unitário e valor total. Ou, para casos de compra por agência de viagem, deve-se enviar a fatura como documento fiscal que contemple o detalhamento das informações: nome completo dos passageiros, trechos, datas, valor unitário e valor total. Lembre-se que todos os documentos devem conter o nome do projeto e número do Pronac.
