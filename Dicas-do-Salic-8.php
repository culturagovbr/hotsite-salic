              ...
              <div class="tabbable tabs-left">
                ...
                <div class="tab-content col-md-12 col-sm-12 col-xs-7 pull-right">
                 ...
                 <div class="tab-pane active" id="a">
                    <div class="dept-title-tabs">Praticamente todas as extensões de arquivos de imagens podem ser inseridas no Salic.</div>
                    <p>
                        Use imagens para comprovar acessibilidade, democratização, quantidade de público e outras informações importantes. Para tanto, você poderá dar upload no Salic muitas extensões de arquivos em imagens: BMP, GIF, JPEG, JPG, PNG, RAW, TIF. Arquivos PDF também são aceitos. O tamanho máximo é de 5MB por arquivo.
