              ...
              <div class="tabbable tabs-left">
                ...
                <div class="tab-content col-md-12 col-sm-12 col-xs-7 pull-right">
                 ...
                 <div class="tab-pane active" id="a">
                    <div class="dept-title-tabs">Desenvolva a prestação de contas ao longo da execução do projeto!</div>
                    <p>
                        A prestação de contas do projeto traduz toda sua implementação. Desta maneira, adequados planejamento e execução do projeto são determinantes para a aprovação da prestação de contas. A prestação de contas se faz mediante o preenchimento dos Relatórios Trimestrais no sistema Novo SALIC (http://novosalic.cultura.gov.br). O ambiente digital traz agilidade ao processo, fortalece o caráter de transparência ao MinC e à sociedade e permite a você, proponente, organização da documentação do projeto durante sua execução.
                        <br><br> <br><br> <br><br>
                    </p>
