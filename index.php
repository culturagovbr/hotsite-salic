            ...
            <div class="complete-content">
                ...
                <div class="container full-width-container ihome-banner">
                    <div class="banner col-sm-12 col-xs-12 col-md-12">
                        ...
                        <ul>
            <!-- SLIDE SHOW DO PORTAL -->
                        <?php include "slideShow.php"; ?>
            <!-- FIM DO SLIDE SHOW DO PORTAL -->
             ...
             <!--Latest Post Start-->
                 ...
                 <div class="col-xs-12 col-sm-12 col-md-6 pull-left">
                    ...
                    <div class="latest-post-wrap pull-left wow fadeInLeft" data-wow-delay="0.5s" data-wow-offset="100">
                        <div class="subtitle col-xs-12 no-pad col-sm-11 col-md-12 pull-left news-sub">Manuais do <strong>SALIC</strong></div>
 ...
 <div class="row">
       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left client-logo-flex wow fadeInUp" data-wow-delay="0.5s" data-wow-offset="100">
           ...
           <ul id="clients-carousel" class="icl-carousel">
            ...
            <div id="settings">
                    <div class="colors">
                    <div class="panel-title">Painel do SALIC</div>
                    <div class="panel-color-title">Seja Bem-Vindo</div>
                        <ul>
                            <li><a title="green" class="color1 color-switch"><i class="fa fa-check"></i></a></li>
                            <li><a title="green" class="color2 color-switch"><i class="fa fa-check"></i></a></li>
                            <li><a title="green" class="color3 color-switch"><i class="fa fa-check"></i></a></li>
                            <li><a title="green" class="color4 color-switch"><i class="fa fa-check"></i></a></li>
                            <li><a title="green" class="color5 color-switch"><i class="fa fa-check"></i></a></li>
                            <li><a title="green" class="color6 color-switch selected"><i class="fa fa-check"></i></a></li>
