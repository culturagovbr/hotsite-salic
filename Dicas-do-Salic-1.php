              ...
              <div class="tabbable tabs-left">
                ...
                <div class="tab-content col-md-12 col-sm-12 col-xs-7 pull-right">
                 ...
                 <div class="tab-pane active" id="a">
                    <div class="dept-title-tabs">Atente-se ao nome de sua Proposta Cultural!</div>
                    <p>
                        O título deve dar ideia concisa e clara do que será realizado e fazer referência ao objeto do seu projeto cultural. No caso de eventos que possuam data fixa (Páscoa, Festejos Juninos, Carnaval, Natal etc.), faça também referência ao tipo do evento no título. O título pode:
                        <br><br>
                       <strong> Note que o título não deve ser muito longo e não deve ser resumo da proposta.</strong>
                        <br><br> <br><br> <br><br>
                    </p>
